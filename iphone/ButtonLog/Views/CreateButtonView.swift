...
struct EditButtonView: View {
    ...
    var body: some View {
        NavigationView {
            Form {
                // Same form content as CreateButtonView but populated with existing data
                Section(header: Text("Basic Information")) {
                    TextField("Button Name", text: $formData.name)
                ...
                // ... rest of the form sections same as CreateButtonView
    ...
    private func saveButton() {
        ...
        Task {
            let success = await appState.updateButton(id: button.id, formData: formData)
