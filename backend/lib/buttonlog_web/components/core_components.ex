defmodule ButtonLogWeb.CoreComponents do
  ...
  use Gettext, backend: ButtonLogWeb.Gettext
  ...
  def input(%{field: %Phoenix.HTML.FormField{} = field} = assigns) do
    errors = if field.errors && field.errors != [], do: field.errors, else: []
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ButtonLogWeb.Gettext, "errors", msg, msg, count, opts)
    else
              Gettext.dgettext(ButtonLogWeb.Gettext, "errors", msg, opts)
    end
  end
