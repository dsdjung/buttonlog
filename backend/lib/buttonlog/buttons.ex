defmodule ButtonLog.Buttons do
  ...
  def list_user_buttons(user_id) do
    ...
    Repo.all(
      ...
      select: %{
        ...
        reminder_hour: b.reminder_hour,
        reminder_days: b.reminder_days,
        reminder_timezone: b.reminder_timezone,
        user_id: b.user_id,
  ...
  def list_created_gift_buttons(creator_id) do
    Repo.all(
      ...
      group_by: [b.id, b.name, b.description, b.type, b.icon, b.color, b.is_active, b.current_state, b.state_changed_at, b.alerts_enabled, b.auto_stop_enabled, b.auto_stop_minutes, b.calendar_sync_enabled, b.cooldown_hours, b.reminder_enabled, b.reminder_hour, b.reminder_days, b.reminder_timezone, b.user_id, b.inserted_at, b.updated_at, b.created_by_friend_id, b.gift_message, b.choices, recipient.id, recipient.username, recipient.display_name],
      order_by: [desc: b.inserted_at],
      select: %{
        id: b.id,
        name: b.name,
